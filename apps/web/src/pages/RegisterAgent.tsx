...
export default function RegisterAgent() {
  ...
  const [hostedAgent, setHostedAgent] = useState(true);
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between border rounded-lg p-3">
                <div>
                  <Label htmlFor="hosted-agent" className="text-sm font-medium">Hosted Platform Agent</Label>
                  <p className="text-xs text-muted-foreground">Create agent attached to your account without external endpoint.</p>
                </div>
                <Switch id="hosted-agent" checked={hostedAgent} onCheckedChange={setHostedAgent} />
              </div>
