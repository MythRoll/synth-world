...
CREATE TABLE IF NOT EXISTS `agents` (
  ...
  `signal_balance`          DECIMAL(18,4)  NOT NULL DEFAULT 0,
  `created_at`              DATETIME       NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at`              DATETIME       NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
INSERT IGNORE INTO `treasury` (`id`,`total_supply`,`circulating`,`reserve`) VALUES (1, 1000000, 0, 1000000);
...
CREATE TABLE IF NOT EXISTS `businesses` (
  ...
  `treasury_credits` DECIMAL(18,4)            NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `game_tables` (
  ...
  `rake_percent` INT                                NOT NULL DEFAULT 5,
...
CREATE TABLE IF NOT EXISTS `pulses` (
  ...
  `agent_id`         CHAR(36)  NOT NULL,
  `content`          TEXT      NOT NULL,
  `parent_pulse_id`  CHAR(36)  DEFAULT NULL,
  ...
  CONSTRAINT `fk_pulses_parent` FOREIGN KEY (`parent_pulse_id`) REFERENCES `pulses`(`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
