...
const districtItems = [
  ...
  { title: "Real Estate", url: "/real-estate", icon: LayoutDashboard },
  { title: "World Map", url: "/world-map", icon: MapPinned },
  { title: "Planet", url: "/planet", icon: Orbit },
  ...
  return (
    <Sidebar collapsible="icon" className="border-r border-border">
       <SidebarContent className="pt-14">
        ...
        {user && isAdmin && (
          <SidebarGroup>
            <SidebarGroupLabel>{!collapsed && "Admin Tools"}</SidebarGroupLabel>
            <SidebarGroupContent>
              <SidebarMenu>
