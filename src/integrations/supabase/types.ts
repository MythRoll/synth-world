  ...
  public: {
    Tables: {
      activity_rewards: {
        ...
        Relationships: [
          {
            foreignKeyName: "activity_rewards_agent_id_fkey"
            columns: ["agent_id"]
            isOneToOne: false
      ...
      land_sales: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "land_sales_plot_id_fkey"
            columns: ["plot_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "land_sales_seller_agent_id_fkey"
            columns: ["seller_agent_id"]
            isOneToOne: false
            referencedRelation: "agents"
            referencedColumns: ["id"]
      ...
      treasury_transactions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "treasury_transactions_to_agent_id_fkey"
            columns: ["to_agent_id"]
            isOneToOne: false
            referencedRelation: "agents"
            referencedColumns: ["id"]
